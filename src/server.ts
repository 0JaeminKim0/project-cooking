    ...
    const sampleProjects = [
      {
        ...
        rfp_content: `AI 기반 인력 운영 전략을 수립하는 글로벌 제조사 컨설팅 프로젝트입니다.

주요 컨설팅 영역:
- 업무 자동화 및 AI 협업 도구 활용 방안
- AI 도입에 따른 직무 재설계 및 HR 전략
- AI 역량 강화 교육 체계 개발
- 인공지능 거버넌스 및 윤리 기준 마련
- 생산성 및 성과 지표 재정립
- 변화관리 전략 및 조직문화 혁신
- 글로벌 AI 인력 활용 벤치마킹
...
프로젝트 기간: 10개월, 25억원
대상: 글로벌 HR 및 생산 부문`,
        requirements: ['AI 도입 전략', 'HR 혁신', '업무자동화', '조직문화 변화', 'AI 거버넌스', '성과관리', '변화관리', '글로벌 벤치마킹']
      },
      {
        name: 'AI 기반 위험성 평가 지원 시스템 구축',  
        client_company: 'Korea Financial Group',
        rfp_content: `AI를 활용한 금융 리스크 관리 체계 고도화 컨설팅 프로젝트입니다.

컨설팅 범위:
- 금융 리스크 데이터 수집·정제 체계 구축
- 머신러닝 기반 위험도 산출 모델 설계
- 시나리오별 리스크 대응 전략
- 실시간 모니터링 대시보드 설계
- 규제 준수 및 컴플라이언스 검증
- 내부통제 체계 강화
- 이해관계자 리포팅 체계 구축
- AI 모델 성능 검증 및 개선 프로세스

기대효과: 금융사고 예방, 리스크 관리 효율성 제고
프로젝트 기간: 9개월`,
        requirements: ['리스크 관리', '금융AI', '머신러닝 모델링', '데이터 거버넌스', '실시간 모니터링', '내부통제', '컴플라이언스', '금융업']
      },
      {
        name: 'AI 기반 R&D 데이터 체계 고도화',
        client_company: 'TechStart Ventures', 
        rfp_content: `R&D 데이터 관리 및 활용도를 높이기 위한 AI 기반 체계 고도화 프로젝트입니다.

컨설팅 서비스:
- 연구 데이터 분류 및 표준화 전략
- 메타데이터 관리 체계 구축
- 연구성과 관리 및 재활용 체계 설계
- LLM 기반 자동 분류 및 검색 시스템 구축
- 지식 그래프 및 온톨로지 설계
- 데이터 품질 관리 및 거버넌스 체계
- 글로벌 R&D 협업 플랫폼 연계 방안
- 보안·권한 관리 체계 수립

목표: 연구 데이터 재활용률 40% 향상
프로젝트 기간: 12개월`,
        requirements: ['R&D 데이터', 'LLM 활용', '메타데이터', '온톨로지', '지식 그래프', '데이터 거버넌스', '연구성과 관리', '검색 최적화']
      }
    ];

    // Sample team members for each project (AI consulting focused)
    const sampleTeamMembers = [
      // AI 구성원 도입 Master Plan 팀
      [
        { name: '김민수', role: 'AI 전략 컨설턴트', mbti: 'ENTJ', skills: 'AI 전략, 업무 자동화, HR 디지털 전환, AI 거버넌스', experience: '8년 AI 도입 컨설팅, 글로벌 제조사 AI 전환 15건' },
        { name: '이수정', role: 'HR 혁신 전문가', mbti: 'INFJ', skills: '직무 재설계, AI 교육, 조직문화 변화, 성과관리', experience: '10년 HR 컨설팅, AI 시대 조직 혁신 전문' },
        { name: '박영호', role: '변화관리 전문가', mbti: 'ENFJ', skills: '변화관리, 커뮤니케이션, 교육 체계, 문화 혁신', experience: '12년 조직 컨설팅, 대규모 AI 전환 관리 경험' },
        { name: '최혜진', role: 'AI 거버넌스 전문가', mbti: 'ISTJ', skills: 'AI 윤리, 거버넌스, 규제 대응, 리스크 관리', experience: '7년 AI 거버넌스 컨설팅, 글로벌 AI 정책 전문' }
      ],
      // AI 기반 위험성 평가 시스템 팀
      [
        { name: '정다영', role: '금융 AI 컨설턴트', mbti: 'INTJ', skills: '금융 AI, 리스크 모델링, 머신러닝, 규제 준수', experience: '9년 금융 AI 컨설팅, 리스크 관리 시스템 구축 전문' },
        { name: '송준혁', role: '데이터 사이언티스트', mbti: 'INTP', skills: '머신러닝, 데이터 분석, 알고리즘 설계, 모델 검증', experience: '8년 금융 데이터 분석, AI 모델 개발 12건' },
        { name: '한소라', role: '컴플라이언스 전문가', mbti: 'ESFJ', skills: '금융 규제, 내부통제, 모니터링, 리포팅', experience: '11년 금융 컴플라이언스, AI 규제 대응 전문' },
        { name: '윤재영', role: '시스템 아키텍트', mbti: 'ESTJ', skills: '시스템 설계, 대시보드, 실시간 모니터링, 인프라', experience: '10년 금융 시스템 구축, 리스크 시스템 아키텍처 전문' }
      ],
      // AI 기반 R&D 데이터 체계 팀
      [
        { name: '임창민', role: 'R&D 데이터 컨설턴트', mbti: 'ENTP', skills: 'R&D 데이터, 연구성과 관리, 메타데이터, 데이터 거버넌스', experience: '9년 R&D 컨설팅, 연구 데이터 체계 구축 20건' },
        { name: '강은영', role: 'LLM 전문가', mbti: 'ENFP', skills: 'LLM, 자연어처리, 지식그래프, 온톨로지', experience: '6년 AI 연구, LLM 기반 검색 시스템 개발 전문' },
        { name: '조성혁', role: '데이터 아키텍트', mbti: 'ISTP', skills: '데이터 아키텍처, 메타데이터, 품질관리, 표준화', experience: '8년 데이터 컨설팅, 연구 데이터 플랫폼 구축 경험' },
        { name: '김나리', role: '보안 및 거버넌스 전문가', mbti: 'ISFJ', skills: '데이터 보안, 권한 관리, 거버넌스, 컴플라이언스', experience: '7년 데이터 보안 컨설팅, 연구기관 보안 체계 전문' }
      ]
    ];
